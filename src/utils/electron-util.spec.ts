...
test("fixes path for Electron apps", () => {
  const path =
    "/Users/fairyhunter13/My.app/Contents/Resources/app.asar/node_modules/foo/binary";
  ...
  expect(fixPathForAsarUnpack(path)).toBe(
    "/Users/fairyhunter13/My.app/Contents/Resources/app.asar.unpacked/node_modules/foo/binary"
  );
});
